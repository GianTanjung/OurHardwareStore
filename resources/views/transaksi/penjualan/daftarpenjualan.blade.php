            ...
            <div class="widget-content widget-content-area">
                <table id="style-3" class="table style-3 dt-table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="{{ route('transaksi.show', $datapenjualan->id) }}">{{ $datapenjualan->kode_nota }}</td>
                            <td><a href="{{ route('transaksi.show', $datapenjualan->id) }}">{{ $datapenjualan->tanggal_transaksi }}</td>                         
                            ...
                            <td class="text-center">
                                ...
                                <form method="POST" action="{{ route('transaksi.destroy', $datapenjualan->id) }}">
                                    @csrf
                                    @method("DELETE")

                                    <a class="btn btn-light-primary btn-icon bs-tooltip"
                                        href="{{ route('transaksi.edit', $datapenjualan->id) }}" data-bs-toggle="tooltip"
                                    ...
                                    <a class="btn btn-light-danger btn-icon bs-tooltip"
                                        href="{{ route('transaksi.destroy', $datapenjualan->id) }}" data-bs-toggle="tooltip"
