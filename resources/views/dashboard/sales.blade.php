...
<ul class="list-unstyled menu-categories" id="accordionExample">
    ...
    <li class="menu">
        <a href="#transaksi" data-bs-toggle="collapse" aria-expanded="false"
        ...
        <div class="widget widget-wallet-one">
            ...
            <ul class="list-group list-group-media">
                <li class="list-group-item ">
                    <div class="media">
                        <div class="me-3">
                            <img alt="avatar" src="{{ asset('assets/src/assets/img/netflix.svg') }}" class="img-fluid rounded-circle">
                        </div>
                ...
                <li class="list-group-item">
                    <div class="media">
                        <div class="me-3">
                            <img alt="avatar" src="{{ asset('assets/src/assets/img/apple-app-store.svg') }}" class="img-fluid rounded-circle">
                        </div>
                        <div class="media-body">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/src/assets/img/profile-13.jpeg') }}" alt="avatar"><span>Luke Ivory</span></div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/src/assets/img/profile-7.jpeg') }}" alt="avatar"><span>Andy King</span></div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/src/assets/img/profile-10.jpeg') }}" alt="avatar"><span>Laurie Fox</span></div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/src/assets/img/profile-5.jpeg') }}" alt="avatar"><span>Ryan Collins</span></div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/src/assets/img/profile-4.jpeg') }}" alt="avatar"><span>Irene Collins</span></div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/src/assets/img/profile-11.jpeg') }}" alt="avatar"><span>Sonia Shaw</span></div>
                                </td>
                                <td>
                ...
                <div class="table-responsive">
                    <table class="table table-scroll">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('assets/src/assets/img/product-headphones.jpg') }}" alt="product">
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('assets/src/assets/img/product-shoes.jpg') }}" alt="product">
                                        <div class="align-self-center">
                                ...
                                <td>
                                    <div class="td-content"><a href="javascript:void(0);" class="text-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-primary feather feather-chevrons-right">
                                                <polyline points="13 17 18 12 13 7"></polyline>
                                                <polyline points="6 17 11 12 6 7"></polyline>
                                            </svg> Google</a></div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('assets/src/assets/img/product-watch.jpg') }}" alt="product">
                                        <div class="align-self-center">
                                ...
                                <td>
                                    <div class="td-content"><a href="javascript:void(0);" class="text-warning"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-warning feather feather-chevrons-right">
                                                <polyline points="13 17 18 12 13 7"></polyline>
                                                <polyline points="6 17 11 12 6 7"></polyline>
                                            </svg> Ads</a></div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('assets/src/assets/img/product-laptop.jpg') }}" alt="product">
                                        <div class="align-self-center">
                                ...
                                <td>
                                    <div class="td-content"><a href="javascript:void(0);" class="text-info"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-info feather feather-chevrons-right">
                                                <polyline points="13 17 18 12 13 7"></polyline>
                                                <polyline points="6 17 11 12 6 7"></polyline>
                                            </svg> Email</a></div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('assets/src/assets/img/product-camera.jpg') }}" alt="product">
                                        <div class="align-self-center">
                                ...
                                <td>
                                    <div class="td-content"><a href="javascript:void(0);" class="text-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-secondary feather feather-chevrons-right">
                                                <polyline points="13 17 18 12 13 7"></polyline>
                                                <polyline points="6 17 11 12 6 7"></polyline>
                                            </svg> Referral</a></div>
                                </td>
