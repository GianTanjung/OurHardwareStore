...
<link rel="stylesheet" type="text/css"
    href="{{ assetOurHardwareStore/resources/views1/laporan/pembelian/detaillaporanpembelian.blade.php('assets/src/plugins/css/dark/table/datatable/dt-global_style.css') }}">
<link rel="stylesheet" type="text/css"
