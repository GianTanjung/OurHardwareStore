...
@section('cssdaftarlaporanpembelian')
...
@section('kontendaftarlaporanpembelian')
<!-- BREADCRUMB -->
<div class="page-meta">
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                ...
                <table id="html5-extension" class="table table-hover range-search" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($listPembelian as $datalaporanpembelian)
                        <tr>
                            <td>{{ $datalaporanpembelian->tgl_pesan }}</td>
                            <td>{{ $datalaporanpembelian->kode_nota }}</td>
                            <td>{{ $datalaporanpembelian->nama_toko }}</td>
                            <td>{{ $datalaporanpembelian->nama_supplier }}</td>
                            <td>{{ $datalaporanpembelian->status }}</td>
                            <td class="text-end">@currency($datalaporanpembelian->grand_total)</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
@section('jsdaftarlaporanpembelian')
