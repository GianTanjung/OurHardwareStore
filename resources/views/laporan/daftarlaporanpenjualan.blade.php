        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                ...
                <table id="html5-extension" class="table table-hover range-search" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($listTransaksi as $datalaporanpenjualan)
                        <tr>
                            <td>{{ $datalaporanpenjualan->tanggal_transaksi }}</td>
                            <td>{{ $datalaporanpenjualan->kode_nota }}</td>
                            <td>{{ $datalaporanpenjualan->nama_toko }}</td>
                            <td>{{ $datalaporanpenjualan->status }}</td>
                            <td class="text-end">@currency($datalaporanpenjualan->grand_total)</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
