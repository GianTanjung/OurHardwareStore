                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="index.html"><img src="{{ asset('assets/src/assets/img/depotbangunan.png') }}" alt="Site Logo"
                            ...
                            <div class="ec-vendor-block">
                                <div class="ec-vendor-block-items">
                                    <ul>
                                        ...
                                        <li><a href="{{Route('customer.transaction.history')}}">Transaction History</a>
                                        </li>
                ...
                <div class="ec-shop-rightside col-lg-9 col-md-12">
                    <div class="ec-vendor-dashboard-card">
                        <div class="ec-vendor-card-header">
                            <h5>Dompet History</h5>
                            <div class="ec-header-btn">
                                <a class="btn btn-lg btn-primary" data-bs-toggle="modal" data-bs-target="#top_up">Top
                                    Up</a>
                            </div>
                        </div>
                        <div class="ec-vendor-card-body">
                            <div class="ec-vendor-card-table">
                                <table class="table ec-table">
                                    ...
                                    <tbody>
                                        @foreach ($riwayatDompet as $dompet)
                                        <tr>
                                            <th scope="row"><span>{{$dompet->arus}}</span></th>
                                            <td><span>{{$dompet->tanggal}}</span></td>
                                            <td><span>{{$dompet->dana}}</span></td>
                                            @if ($dompet->validasi_topup == 0)
