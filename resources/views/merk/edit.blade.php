...
<div class="row mb-4 layout-spacing layout-top-spacing">
    ...
    <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="widget-content widget-content-area ecommerce-create-section">
            <form method="POST" action="{{route('merkUpdate')}}">
                @csrf
                @method("PUT")
                <input type="hidden" name="input-id" id="input-id" value="{{$merk->id}}">
                <div>        
                    <div class="row">
                        <div class="col-md-8">
                            <label for="input-nama">Nama</label>
                            <div class="multiple-file-upload">
                                <input type="text" class="form-control" name="input-name" id="input-name" value="{{$merk->nama}}" placeholder="Nama Produk">
                            </div>
                        </div>        
                    </div>
                </div>
                <div>        
                    <div class="row">
                        <div class="col-md-8">
                            <label for="input-foto">Foto Merk</label>
                            <div class="multiple-file-upload">
                                <input type="text" class="form-control" name="input-foto" id="input-foto" value="{{$merk->foto_merk}}" placeholder="Link Foto Produk">
                            </div>
                        </div>        
                    </div>
                </div><br>
