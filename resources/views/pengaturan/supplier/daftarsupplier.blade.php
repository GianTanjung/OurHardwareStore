            ...
            <div class="widget-content widget-content-area">
                <table id="style-3" class="table style-3 dt-table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="{{ route('supplier.show', $datasupplier->id) }}">{{ $datasupplier->id }}</a></td>
                            <td><a href="{{ route('supplier.show', $datasupplier->id) }}">{{ $datasupplier->nama }}</a></td>

                            <td>{{ $datasupplier->no_hp }}</a></td>
                            <td>{{ $datasupplier->email }}</a></td>
                            <td>{{ $datasupplier->alamat }}</a></td>
                            ...
                            <td class="text-center">
                                ...
                                <form method="POST" action="{{ route('supplier.destroy', $datasupplier->id) }}">
                                    ...
                                    <a class="btn btn-light-danger btn-icon bs-tooltip"
                                        href="{{ route('supplier.destroy', $datasupplier->id) }}" data-bs-toggle="tooltip"
