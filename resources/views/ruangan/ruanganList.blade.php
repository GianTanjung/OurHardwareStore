        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <table id="style-3" class="table style-3 dt-table-hover">
                    ...
                    <tbody>
                        @foreach ($ruanganList as $dataruangan)
                        <tr>
                            <td>{{ $dataruangan->id }}</a></td>
                            <td>{{ $dataruangan->nama }}</a></td>

                            <td class="text-center">

                                <form method="POST" action="{{ route('ruangan.destroy', $dataruangan->id) }}">
                                    @csrf
                                    @method("DELETE")

                                    <a class="btn btn-light-primary btn-icon bs-tooltip"
                                        href="{{ route('ruangan.edit', $dataruangan->id) }}" data-bs-toggle="tooltip"
                                    ...
                                    <a class="btn btn-light-danger btn-icon bs-tooltip"
                                        href="{{ route('ruangan.destroy', $dataruangan->id) }}" data-bs-toggle="tooltip"
