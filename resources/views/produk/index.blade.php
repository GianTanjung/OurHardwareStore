        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <table id="style-3" class="table style-3 table-hover">
                    ...
                    <tbody>
                        @foreach ($listProduct as $dataproduk)
                        <tr>
                            <td><a href="{{ route('detailproduk.detail', ['id' => $dataproduk->id]) }}">{{
                                    $dataproduk->id }}</a></td>
                            <td><a href="{{ route('detailproduk.detail', ['id' => $dataproduk->id]) }}">{{
                                    $dataproduk->nama }}</a></td>
                            <td>{{ $dataproduk->tipe }}</td>
                            <td>{{ $dataproduk->merk_nama }}</td>

                            {{-- @if ($datakain->stok < 1) <td><span class="badge badge-light-danger">Habis</span></td>
                                @elseif ($datakain->stok <= 100) <td><span class="badge badge-light-warning">Hampir
                                        Habis</span></td>
                                    @else
                                    ...
                                    <td class="text-center">
                                        <a class="badge badge-light-primary text-start me-2 action-edit bs-tooltip"
                                            href="produkEdit/{{$dataproduk->id}}" data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <a class="badge badge-light-danger text-start action-delete bs-tooltip"
                                            href="produkDelete/{{$dataproduk->id}}" data-bs-toggle="tooltip" data-bs-placement="top"
