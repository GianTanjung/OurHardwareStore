...
<div class="row mb-4 layout-spacing">
    ...
    <form enctype="multipart/form-data" class="row g-3" method="POST" action="{{ route('merk.store') }}">
        @csrf
            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col">
                        ...
                        <div class="col">
                            <input type="file" class="form-control @error('foto_merk') is-invalid @enderror"
                                name="foto_merk">
                            @error('foto_merk')
                            <div class="invalid-feedback">
                                {{ $message }}
