...
<div class="row mb-4 layout-spacing">
    ...
    <form enctype="multipart/form-data" class="row g-3" method="POST" action="{{ route('ruangan.store') }}">
        @csrf
                    ...
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" value="{{ old('nama') }}"
                                ...
                                placeholder="Nama Ruangan" autofocus>
                            @error('nama')
