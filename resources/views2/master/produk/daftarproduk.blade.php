            ...
            <div class="widget-content widget-content-area">
                <table id="style-3" class="table style-3 dt-table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="{{ route('produk.show', $dataproduk->id) }}">{{ $dataproduk->id }}</a></td>
                            <td><a href="{{ route('produk.show', $dataproduk->id) }}">{{ $dataproduk->sku }}</a></td>
                            <td class="truncate-text"><a href="{{ route('produk.show', $dataproduk->id) }}">{{ $dataproduk->nama }}</a></td>
                            <td>{{ $dataproduk->nama_merk }}</td>
                            ...
                            <td class="text-center">
                                ...
                                <form method="POST" action="{{ route('produk.destroy', $dataproduk->id) }}">
                                    ...
                                    <a class="btn btn-light-primary btn-icon bs-tooltip"
                                        href="{{ route('produk.edit', $dataproduk->id) }}" data-bs-toggle="tooltip"
                                    ...
                                    <a class="btn btn-light-danger btn-icon bs-tooltip"
                                        href="{{ route('produk.destroy', $dataproduk->id) }}" data-bs-toggle="tooltip"
