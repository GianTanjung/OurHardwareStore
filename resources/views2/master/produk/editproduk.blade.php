            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col">
                        ...
                        <select class="form-select @error('subkategori_id') is-invalid @enderror" name="subkategori_id">
                            ...
                            <option value="{{ $subkategori->id }}" {{ $detailProduk[0]->subkategori_id==$subkategori->id ?
                ...
                <div class="row mb-4">
                    <div class="col">
                        <label>Ruangan</label>
                        <div class="col-sm-12">
                            <input class="form-control @error('ruangan') is-invalid @enderror" value="{{ implode(', ', array_column(json_decode($detailRuangan, true), 'nama')) }}"  name="ruangan" placeholder="Choose...">
                            @error('ruangan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
