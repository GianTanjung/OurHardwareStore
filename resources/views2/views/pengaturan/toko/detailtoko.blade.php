                ...
                <div class="order-summary">
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>No. Telp<span class="summary-count">{{ $detailToko[0]->email
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Negara<span class="summary-count">{{ $detailToko[0]->negara
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Keterangan<span class="summary-count">{{ $detailToko[0]->keterangan
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
