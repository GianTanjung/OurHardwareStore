...
<div class="page-meta">
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ $detailSupplier[0]->id }} - {{
                $detailSupplier[0]->nama }}</li>
        </ol>
    </nav>
</div>
<!-- /BREADCRUMB -->
                ...
                <div class="order-summary">
                        ...
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Nama<span class="summary-count">{{ $detailSupplier[0]->nama }}</span>
                                    </h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>No. Telp<span class="summary-count">{{ $detailSupplier[0]->no_hp
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Email<span class="summary-count">{{ $detailSupplier[0]->email
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Alamat<span class="summary-count">{{ $detailSupplier[0]->alamat
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Kecamatan<span class="summary-count">{{ $detailSupplier[0]->kecamatan
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Kota<span class="summary-count">{{ $detailSupplier[0]->kota
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Provinsi<span class="summary-count">{{ $detailSupplier[0]->provinsi
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Kode Pos<span class="summary-count">{{ $detailSupplier[0]->kode_pos
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Negara<span class="summary-count">{{ $detailSupplier[0]->negara
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
                    ...
                    <div class="summary-list">
                        <div class="summery-info">
                            <div class="w-summary-details">
                                <div class="w-summary-info">
                                    <h6>Keterangan<span class="summary-count">{{ $detailSupplier[0]->keterangan
                                            }}</span>
                                    </h6>
                                </div>
                            </div>
