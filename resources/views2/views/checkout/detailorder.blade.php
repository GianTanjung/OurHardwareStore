                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                        <a data-bs-toggle="modal" data-bs-target="#top_up"><span
                                                class="text-success text-sm font-weight-bolder">+ ISI SALDO</span></a>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="ec-sb-block-content">
                                    ...
                                    <div class="ec-product-inner">
                                            ...
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('uploads/' . $keranjang->produks->foto_produk) }}"
                                                        alt="Produk" />
                                                </a>
                                            </div>
                                        </div>
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a
                                                    href="product-left-sidebar.html">{{$keranjang->produks->nama}}</a>
                                            </h5>
                                            <span class="ec-price">
                                                <span>Harga: Rp {{number_format(($keranjang->produks->harga), 2, ',',
                                                    '.')}} x {{$keranjang->kuantitas}} =&nbsp;</span>
                                                <span class="new-price"> Rp
                                                    {{number_format(($keranjang->produks->harga*$keranjang->kuantitas),
                                                    2, ',', '.')}}</span>
                                            </span>
                            ...
                            <div class="ec-checkout-summary">
                                ...
                                <div>
                                    ...
                                    <span class="text-right">Rp {{number_format(($totalHarga*0.11), 2, ',',
                                        '.')}}</span>
                                </div>
                                <div>
                                ...
                                <div class="ec-checkout-summary-total">
                                    ...
                                    <span class="text-right total-harga">Rp {{number_format(($totalHarga*1.11), 2, ',',
                                        '.')}}</span>
                ...
                <div class="ec-sidebar-wrap ec-checkout-del-wrap">
                                ...
                                <form action="#">
                                    <div class="ec-checkout-rightside row">
                                        <div class="col-sm-6 mb-6">
                                            <input id="rdoToko" type="radio" name="metode_pengiriman" value="Ambil Toko"
                                                checked>
                                            <span class="font-weight-bold" style="margin-left: 18rem">Ambil Toko</span>
                                        </div>
                                        <div class="col-sm-6 mb-6">
                                            <input id="rdoRumah" type="radio" name="metode_pengiriman"
                                                value="Antar Di tempat">
                                            <span class="font-weight-bold" style="margin-left: 17rem">Antar Di
                                                tempat</span>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="ec-checkout-del">
                                ...
                                <form action="#">
                                    <div class="ec-checkout-rightside row">
                                        ...
                                        <div class="col-sm-6 mb-6">
                                            <input class="ongkir-radio" type="radio" name="ongkir" value="{{ $value }}"
                                                data-key="{{ $key }}">
                                            ...
                                            @if ( $keyEst == $key )
                                            <span class="text-xs font-weight-bold ml-10">&nbsp&nbspEstimasi sampai:
                                                {{$est}}</span>
                                            @endif
                                            @endforeach
                                        </div>
                    ...
                    <span class="ec-check-order-btn">
                        <div class="card-footer p-3">
                            <form action="{{ route('buat.order') }}" method="POST" id="form-beli"
...
<div class="modal fade" id="konfirmasi-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
...
<div class="modal fade" id="top_up" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="ec-vendor-block-img space-bottom-30">
                        <div class="ec-vendor-upload-detail">
                            <form action="{{route('customer.insert.topup')}}" method="POST"
                                enctype="multipart/form-data" class="row g-3">
                                @csrf
                                <div class="col-md-12 space-t-15">
                                    <label class="form-label">Jumlah Dana</label>
                                    <input type="text" name="dana" value="" placeholder="{{__('Masukkan Jumlah')}}"
                                        required />
                                </div>
                                <div class="col-md-12 space-t-15">
                                    <label class="form-label">Bukti Transfer</label>
                                    <input type="file" name="bukti_transfer" value="" required />
                                </div>
                                <div class="col-md-12 space-t-15">
                                    <label class="form-label">Top Up Dompet minimal sebesar Rp 10,000. Pembayaran
                                        melalui transfer bank BCA: 1234567890 A/N Gian Tanjung</label>
                                </div>
                                <div class="col-md-12 space-t-15">
