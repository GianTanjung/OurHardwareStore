                                ...
                                <div class="ec-product-inner">
                                    <div class="ec-pro-image-outer">
                                        <div class="ec-pro-image">
                                            <a href="{{route('detail', $p->id)}}" class="image">
                                                <img class="main-image" src={{ asset('uploads/' . $p->foto_produk) }}
                                                alt="Product" />
                                    ...
                                    <div class="ec-pro-content">
                                        <h5 class="ec-pro-title"><a href={{route('detail', $p->id)}}>{{$p->nama}}</a>
                                        </h5>
                                        ...
                                        <span class="ec-price">
                                            ...
                                            <span class="new-price">Rp {{number_format(($p->harga) / 1, 2, '.',
                                                ',')}}</span>
                                        </span>
                                        ...
                                        <li>
                                            <div class="ec-sidebar-block-item">
                                                <input type="checkbox" name="kategori[]" value="{{$k->id}}"
                                                    onchange="this.form.submit()" @if(in_array($k->id,
                                                $selectedkategori)) checked
                                                @endif/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$k->nama}}<span
                                                    class="checked"></span>
                                            </div>
                                        </li>
                            ...
                            <div class="ec-sidebar-block">
                                ...
                                <div class="ec-sb-block-content">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="ec-sidebar-block-item">
                                                <input type="checkbox" name="store[]" value="{{$s->id}}"
                                                    onchange="this.form.submit()" @if(in_array($s->id, $selectedstore))
                                                checked @endif/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$s->nama}}<span
                                                    class="checked"></span>
                                            </div>
                                        </li>
                                        @endforeach
