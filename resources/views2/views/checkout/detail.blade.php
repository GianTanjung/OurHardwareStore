                            ...
                            <div class="row">
                                <div class="single-pro-img single-pro-img-no-sidebar">
                                    <div class="single-product-scroll">
                                        <a class="ec-360-lbl" data-link-action="quickview" title="360 view"
                                            data-bs-toggle="modal" data-bs-target="#ec_360_view_modal">
                                            <img src={{ asset('uploads/' . $produk->foto_produk) }} alt="view image">
                                        </a>
                                        <div class="single-product-cover">
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src={{ asset('uploads/' .
                                                    $produk->foto_produk) }}
                                                alt="">
                                            </div>
                                        </div>
                                    ...
                                    <div class="single-pro-content">
                                        ...
                                        <div class="ec-single-price-stoke">
                                            <div class="ec-single-price">
                                                ...
                                                <span class="new-price">Rp {{number_format(($produk->harga) / 1, 2, '.',
                                                    ',')}}</span>
                                            </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <li style="width: 130px;">
                                                                    <input class="lokasi" type="radio" name="lokasi"
                                                                        value="{{$l->id}}" id="lokasi"
                                                                        style="width: 20px; height: 20px;"> {{$l->nama}}
                                                                </li>
                                                            </td>
                                                        </tr>
                                                        {{-- <li style="width: 100px;"><input type="radio"
                                                                style="width: 20px; height: 20px;" name="lokasi"
                                                                value="{{$l->id}}">{{$l->nama}}</li> --}}
                                                        {{-- <div class="button-radio"
                                                            onclick="selectOption('option1')">{{$l->nama}}</div> --}}
                                                        @endforeach
    ...
    <div class="ec-cart-inner">
        <div class="ec-cart-top">
            ...
            <ul class="eccart-pro-items">
                ...
                <li>
                    <a href="product-left-sidebar.html" class="sidekka_pro_img"><img src={{ asset('uploads/' .
                            $c->foto_produk) }}
                        alt="product"></a>
                    <div class="ec-pro-content">
                        <a href="product-left-sidebar.html" class="cart_pro_title">{{$c->nama}}</a>
                        <span class="cart-price"><span>{{number_format(($c->harga) / 1, 2, '.', ',')}}</span> x
                            {{$c->kuantitas}}</span>
                        <div class="qty-plus-minus">
