...
<link href="{{ asset('assets/src/assets/css/light/apps/invoice-edit.css') }}" rel="stylesheet" type="text/css" />
...
<link href="{{ asset('assets/src/assets/css/dark/apps/invoice-edit.css') }}" rel="stylesheet" type="text/css" />

@endsection

@section('konteneditpenjualan')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="company-name" placeholder="Business Name" value="Cork Inc.">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-5 invoice-address-client">
                                        ...
                                        <div class="invoice-address-client-fields">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="client-name" placeholder="Client Name" value="Jesse Cory">
                                                </div>
                                            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="description"><input type="text"
                                                        ...
                                                        value="Calendar App Customization"> <textarea
                                                        class="form-control"
                                                        placeholder="Additional Details">Make Calendar App Dynamic</textarea>
                                                </td>
                                                <td class="rate">
                                                    <input type="text" class="form-control form-control-sm"
                                                ...
                                                <td class="text-right amount"><span class="editable-amount"><span
                                                            ...
                                                            class="amount">120.00</span></span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="description"><input type="text"
                                                        class="form-control form-control-sm"
                                                        placeholder="Item Description" value="Chat App Customization">
                                                    <textarea class="form-control"
                                                        placeholder="Additional Details">Customized Chat Application to resolve some Bug Fixes</textarea>
                                                </td>
                                                <td class="rate">
                                                    <input type="text" class="form-control form-control-sm"
                                                ...
                                                <td class="text-right amount"><span class="editable-amount"><span
                                                            class="currency">$</span> <span
                                                            class="amount">25.00</span></span></td>
                                                <td class="text-center tax">
                                                    <div class="n-chk">
                                                        <div
                                                            class="form-check form-check-primary form-check-inline me-0 mb-0">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row invoice-created-by">
                                            <label for="payment-method-account"
                                                class="col-sm-3 col-form-label col-form-label-sm">Account #:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm"
                                                    id="payment-method-account" placeholder="Bank Account Number"
                                                    value="1234567890">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row invoice-created-by">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm"
                                                    id="payment-method-bank-name" placeholder="Insert Bank Name"
                                        ...
                                        <div class="form-group row invoice-created-by">
                                            <label for="payment-method-code"
                                                class="col-sm-3 col-form-label col-form-label-sm">SWIFT code:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm"
                                                    id="payment-method-code" placeholder="Insert Code" value="VS70134">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row invoice-created-by">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="country_code"
                                                    ...
                                                    <option value="Sao-Tome-and-Principe">São Tomé &amp; Príncipe
                                                    </option>
                                        ...
                                        <div class="form-group row invoice-note">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea class="form-control" id="invoice-detail-notes"
                                                    ...
                                                    style="height: 88px;">Thank you for doing business with us.</textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="invoice-action-currency">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="dropdown selectable-dropdown invoice-select">
                                    <a id="currencyDropdown" href="javascript:void(0);" class="dropdown-toggle"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                            src="../src/assets/img/flag-us.svg" class="flag-width" alt="flag"> <span
                                            class="selectable-text">USD - US Dollar</span> <span
                                            class="selectable-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="currencyDropdown">
                                        <a class="dropdown-item" data-img-value="../src/assets/img/flag-us.svg"
                                            data-value="USD - US Dollar" href="javascript:void(0);"><img
                                                src="../src/assets/img/flag-us.svg" class="flag-width" alt="flag"> USD -
                                            US Dollar</a>
                                        <a class="dropdown-item" data-img-value="../src/assets/img/flag-gbp.svg"
                                            data-value="GBP - British Pound" href="javascript:void(0);"><img
                                                src="../src/assets/img/flag-gbp.svg" class="flag-width" alt="flag"> GBP
                                            - British Pound</a>
                                        <a class="dropdown-item" data-img-value="../src/assets/img/flag-idr.svg"
                                            data-value="IDR - Indonesian Rupiah" href="javascript:void(0);"><img
                                                src="../src/assets/img/flag-idr.svg" class="flag-width" alt="flag"> IDR
                                            - Indonesian Rupiah</a>
                                        <a class="dropdown-item" data-img-value="../src/assets/img/flag-inr.svg"
                                            data-value="INR - Indian Rupee" href="javascript:void(0);"><img
                                                src="../src/assets/img/flag-inr.svg" class="flag-width" alt="flag"> INR
                                            - Indian Rupee</a>
                                        <a class="dropdown-item" data-img-value="../src/assets/img/flag-brl.svg"
                                            data-value="BRL - Brazilian Real" href="javascript:void(0);"><img
                                                src="../src/assets/img/flag-brl.svg" class="flag-width" alt="flag"> BRL
                                            - Brazilian Real</a>
                                        <a class="dropdown-item" data-img-value="../src/assets/img/flag-de.svg"
                                            data-value="EUR - Germany (Euro)" href="javascript:void(0);"><img
                                                src="../src/assets/img/flag-de.svg" class="flag-width" alt="flag"> EUR -
                                            Germany (Euro)</a>
                                        <a class="dropdown-item" data-img-value="../src/assets/img/flag-try.svg"
                                            data-value="TRY - Turkish Lira" href="javascript:void(0);"><img
                                                src="../src/assets/img/flag-try.svg" class="flag-width" alt="flag"> TRY
                                            - Turkish Lira</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div class="dropdown selectable-dropdown invoice-tax-select">
                                                <a id="taxTypeDropdown" href="javascript:void(0);"
                                                    class="dropdown-toggle" data-bs-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false"> <span
                                                        class="selectable-text">On Total</span> <span
                                                        class="selectable-arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-0">
                                            ...
                                            <div class="dropdown selectable-dropdown invoice-discount-select">
                                                <a id="discountTypeDropdown" href="javascript:void(0);"
                                                    class="dropdown-toggle" data-bs-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false"> <span
                                                        class="selectable-text">Flat Amount</span> <span
                                                        class="selectable-arrow"><svg xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-0 discount-amount">
                                            ...
                                            <input type="number" class="form-control input-rate" id="rated1"
                                                placeholder="Rate" value="25">
                                        </div>

                                        <div class="form-group mb-0 discount-percent" style="display: none;">
                                            <label for="rated2">Percent</label>
                                            <input type="number" class="form-control input-rate" id="rated2"
                                                placeholder="Rate" value="10">
                                        </div>
                                    </div>
