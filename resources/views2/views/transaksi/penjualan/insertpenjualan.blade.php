            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                    ...
                    <div class="col-4">
                        ...
                        <div class="col-sm-12">
                            <input type="text" value="{{ old('sku') }}"
                                ...
                                placeholder="SKU Produk" autofocus>
                            @error('sku')
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <select class="form-select @error('kategoris_id') is-invalid @enderror"
                            name="kategoris_id">
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <select class="form-select @error('ruangans_id') is-invalid @enderror" name="ruangans_id">
                            ...
                            @if (old('ruangans_id') == $kategori->id)
                    ...
                    <div class="col">
                        ...
                        <select class="form-select @error('sales_uoms_id') is-invalid @enderror" name="sales_uoms_id">
                            ...
                            @if (old('sales_uoms_id') == $salesuom->id)
                ...
                <div class="row mb-4">
                    <div class="col-7">
                        ...
                        <div class="col-sm-12">
                            <input type="text" value="{{ old('tipe') }}" class="form-control @error('tipe') is-invalid @enderror"
                    ...
                    <div class="col">
                        <label>Harga</label>
                        <div class="col-sm-12">
                            <input type="text" value="{{ old('harga') }}" class="form-control @error('harga') is-invalid @enderror"
                ...
                <div class="row mb-4">
                    <div class="col">
                        <label>Lebar</label>
                        <div class="col-sm-12">
                            <input type="text" value="{{ old('lebar') }}" class="form-control @error('lebar') is-invalid @enderror"
                    ...
                    <div class="col">
                        <label>Panjang</label>
                        <div class="col-sm-12">
                            <input type="text" value="{{ old('panjang') }}" class="form-control @error('panjang') is-invalid @enderror"
                    ...
                    <div class="col">
                        <label>Tinggi</label>
                        <div class="col-sm-12">
                            <input type="text" value="{{ old('tinggi') }}" class="form-control @error('tinggi') is-invalid @enderror"
                    ...
                    <div class="col">
                        <label>Berat</label>
                        <div class="col-sm-12">
                            <input type="text" value="{{ old('berat') }}" class="form-control @error('berat') is-invalid @enderror"
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                            value="{{ old('deskripsi') }}" rows="5" placeholder="Deskripsi"
                    ...
                    <div class="col">
                        ...
                        <div class="multiple-file-upload">
                            <input type="file" name="fotoProduk" id="input-foto"
                                class="filepond file-upload-multiple @error('fotoProduk') is-invalid @enderror"
