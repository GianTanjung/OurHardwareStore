...
<body class="shop_page">
                        ...
                        <div class="ec-sidebar-block">
                            <div class="ec-vendor-block">
                                ...
                                <div class="ec-vendor-block-detail">
                                    <img class="v-img" src="{{asset('assets')}}/images/user/1.jpg" alt="vendor image">
                                    <h5>Mariana Johns</h5>
                                </div> -->
                                <div class="ec-vendor-block-items">
                                    <ul>
                                        ...
                                        <li><a href="{{Route('customer.dompet.history')}}">Dompet History</a></li>
                                        ...
                                        <div class="ec-vendor-block-img space-bottom-30">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="m-2 p-2" style="width: 150px;border: 1px solid grey;border-radius: 5px">
                                                    <h6>Poin</h6>
                                                    <h3>{{$pelanggan->poin}}</h3>
                                                </div>
                                            </div>
                                            <div class="ec-vendor-block-detail">
                                                <h5 class="name">{{$pelanggan->nama}}</h5>
                                            </div>
                                            <p>Hello <span>{{$pelanggan->nama}}!</span></p>
                                            <p>From your account you can manage and change your account information like address, contact information and history of orders.</p>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="ec-vendor-detail-block ec-vendor-block-email space-bottom-30">
                                                    <h6>E-mail address <a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{asset('assets')}}/images/icons/edit.svg"
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="ec-vendor-detail-block ec-vendor-block-contact space-bottom-30">
                                                    <h6>Contact nubmer<a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{asset('assets')}}/images/icons/edit.svg"
                                                        class="svg_img pro_svg" alt="edit" /></a></h6>
                                                    <ul>
                                                        <li><strong>Phone : </strong>{{$pelanggan->no_hp}}</li>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="ec-vendor-detail-block ec-vendor-block-address mar-b-30">
                                                    <h6>Address<a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{asset('assets')}}/images/icons/edit.svg"
                                                        class="svg_img pro_svg" alt="edit" /></a></h6>
                                                    <ul>
                                                        <li><strong>Home : </strong>{{$pelanggan->alamat.','.$pelanggan->kecamatan.','.$pelanggan->kota.','.$pelanggan->kode_pos}}</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-6 col-sm-12">
                                                <div class="ec-vendor-detail-block ec-vendor-block-address">
                                                    <h6>Shipping Address<a href="javasript:void(0)" data-link-action="editmodal" title="Edit Detail" data-bs-toggle="modal" data-bs-target="#edit_modal"><img src="{{asset('assets')}}/images/icons/edit.svg"
                                                        class="svg_img pro_svg" alt="edit" /></a></h6>
                                                    <ul>
                                    ...
                                    <div class="thumb-preview ec-preview">
                                        <div class="image-thumb-preview">
                                            <img class="image-thumb-preview ec-image-preview v-img"
                                                src="{{asset('assets')}}/images/banner/8.jpg" alt="edit" />
                                        </div>
                                    </div>
                                </div>
                            </div> --}}
                            {{-- <div class="ec-vendor-block-detail">
                                <div class="thumb-upload">
                                    ...
                                    <div class="thumb-preview ec-preview">
                                        <div class="image-thumb-preview">
                                            <img class="image-thumb-preview ec-image-preview v-img"
                                                src="{{asset('assets')}}/images/user/1.jpg" alt="edit" />
                                        </div>
                                    </div>
                                </div>
                            </div> --}}
                            <div class="ec-vendor-upload-detail">
                                <form action="{{route('customer.profile.update')}}" class="row g-3">
                                    <div class="col-md-12 space-t-15">
                                        <label class="form-label">Name</label>
                                        <input type="text" name="name" value="{{$pelanggan->nama}}" placeholder="{{__('Enter name')}}" required />
                                    </div>
                                    <div class="col-md-6 space-t-15">
                                        <label class="form-label">Email</label>
                                        <input type="email" name="email" value="{{$pelanggan->email}}" placeholder="{{__('Enter email')}}" required />
                                    </div>
                                    <div class="col-md-6 space-t-15">
                                        <label class="form-label">Phone</label>
                                        <input type="tel" name="phone" value="{{$pelanggan->no_hp}}" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="ex: 012-345-6789" maxlength="12" required />
                                    </div>
                                    <div class="col-md-6 space-t-15">
                                        <label class="form-label">Address</label>
                                        <input type="text" name="address" value="{{$pelanggan->alamat}}" placeholder="{{__('Enter AAdress')}}" required />
                                    </div>
                                    <div class="col-md-6 space-t-15">
                                        <label class="form-label">Postal Code</label>
                                        <input type="text" name="postal" value="{{$pelanggan->kode_pos}}" placeholder="{{__('Enter Postal Code')}}" required />
                                    </div>
                                    <div class="col-md-6 space-t-15">
    ...
    <script src="{{asset('assets')}}/js/vendor/bootstrap-tagsinput.js"></script>
