...
<div class="page-meta">
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Daftar Top Up</li>
        </ol>
    </nav>
</div>
<!-- /BREADCRUMB -->
            ...
            <div class="widget-content widget-content-area">
                <table id="style-3" class="table style-3 dt-table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $dompet->tanggal }}</a></td>
                            <td>{{ $dompet->nama_pelanggan }}</a></td>
                            <td>@currency($dompet->dana)</a></td>
                            ...
                            <td class="text-center">
                                <img class="text-center" src="{{ asset('uploads/' . $dompet->bukti_transfer) }}"
                                    style="width: 20%">
                            </td>
                            ...
                            @else
                                <a class="btn btn-light-primary btn-icon bs-tooltip"
                                        href="{{ route('dompet.updateSetuju', $dompet->id) }}" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Setuju" data-original-title="Setuju"><i
                                            data-feather="check"></i></a>

                                    <a class="btn btn-light-danger btn-icon bs-tooltip"
                                        href="{{ route('dompet.updateTolak', $dompet->id) }}" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Tolak" data-original-title="Tolak"
                                        type="submit"><i data-feather="x"></i></a>
                            @endif
