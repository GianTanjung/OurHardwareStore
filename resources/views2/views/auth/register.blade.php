                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data"
                            ...
                            <span class="ec-register-wrap">
                                ...
                                <input type="tel" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"
                                    placeholder="ex: 012-345-6789" maxlength="12" required />
                            </span>
                            <span class="ec-register-wrap ec-register-half">
                            ...
                            <span class="ec-register-wrap ec-register-half">
                                ...
                                <input type="password" id="password-confirm" name="password_confirmation"
                                    ...
                                    autocomplete="new-password" placeholder="{{__('Re-password')}}" />
                            </span>
                            <span class="ec-register-wrap ec-register-half">
                            ...
                            <span class="ec-register-wrap ec-register-half">
                                ...
                                <span class="ec-rg-select-inner">
                                    <select id="province" name="province" class="ec-register-select"
                                        onchange="getCity()">
                                        <option selected disabled>Select Province</option>
                                        @foreach($provinceList as $province )
                                        <option value="{{ $province->name }}" {{ old('province')==$province->id ?
