                        ...
                        <div class="ec-header-bottons">
                            ...
                            <div class="ec-header-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    @auth
                                    <li><a class="dropdown-item" href="{{Route('customer.profile')}}">User Profile</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="{{Route('customer.transaction.history')}}">History</a></li>
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="{{ route('listProduct') }}"><img src="{{ asset('assets/src/assets/img/depotbangunan.png') }}" alt="Site Logo"
                                        style="width: 100px" /><img class="dark-logo" src="{{ asset('assets/src/assets/img/depotbangunan.png') }}"
                        ...
                        <div class="align-self-center">
                            <div class="ec-header-bottons">
                                ...
                                <div class="ec-header-user dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        @auth
                                        <li><a class="dropdown-item" href="{{Route('customer.profile')}}">User
                                                Profile</a></li>
                                        <li><a class="dropdown-item"
                                                href="{{Route('customer.transaction.history')}}">History</a></li>
                                        <li><a class="dropdown-item" href="{{Route('cart')}}">Cart</a></li>
                                        ...
                                        <div class="single-product-cover">
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive"
                                                    src="{{asset('assets/images/product-360/1_1.jpg')}}" alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive"
                                                    src="{{asset('assets/images/product-360/1_2.jpg')}}" alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive"
                                                    src="{{asset('assets/images/product-360/1_3.jpg')}}" alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive"
                                                    src="{{asset('assets/images/product-360/1_4.jpg')}}" alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive"
                                                    src="{{asset('assets/images/product-360/1_5.jpg')}}" alt="">
                                            </div>
                                        </div>
                            ...
                            <div class="ec-pro-image">
                                ...
                                <div class="ec-pro-actions">
                                    <a href="compare.html" class="ec-btn-group compare" title="Compare"><img
                                            src="{{asset('assets/images/icons/compare.svg')}}" class="svg_img pro_svg"
                                            alt="" /></a>
                        ...
                        <div class="col-sm-12 col-lg-3 ec-footer-contact">
                            <div class="ec-footer-widget">
                                <div class="ec-footer-logo"><a href="#"><img
                                            src="{{asset('assets/images/logo/footer-logo.png')}}" alt=""><img
                                            class="dark-footer-logo" src="{{asset('assets/images/logo/dark-logo.png')}}"
                            ...
                            <div class="ec-360-panel ec-360-panel-default">
                                ...
                                <div class="ec-360-panel-body">
                                    <div id="circlr" class="ec-circlr">
                                        <img data-src="{{asset('assets/images/product-360/00.jpg')}}"
                                            src="{{asset('assets/images/product-360/00.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/01.jpg')}}"
                                            src="{{asset('assets/images/product-360/01.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/02.jpg')}}"
                                            src="{{asset('assets/images/product-360/02.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/03.jpg')}}"
                                            src="{{asset('assets/images/product-360/03.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/04.jpg')}}"
                                            src="{{asset('assets/images/product-360/04.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/05.jpg')}}"
                                            src="{{asset('assets/images/product-360/05.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/06.jpg')}}"
                                            src="{{asset('assets/images/product-360/06.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/07.jpg')}}"
                                            src="{{asset('assets/images/product-360/07.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/08.jpg')}}"
                                            src="{{asset('assets/images/product-360/08.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/09.jpg')}}"
                                            src="{{asset('assets/images/product-360/09.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/10.jpg')}}"
                                            src="{{asset('assets/images/product-360/10.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/11.jpg')}}"
                                            src="{{asset('assets/images/product-360/11.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/12.jpg')}}"
                                            src="{{asset('assets/images/product-360/12.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/13.jpg')}}"
                                            src="{{asset('assets/images/product-360/13.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/14.jpg')}}"
                                            src="{{asset('assets/images/product-360/14.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets/images/product-360/15.jpg')}}"
                                            src="{{asset('assets/images/product-360/15.jpg')}}" alt="product image">
                                        <div id="loader" class="ec-img-loader"></div>
                                    </div>
                                </div>
                                <p class="ec-tool-play">
                                    <a href="#" class="btn btn-default ec-360-btn"
                                        onclick="crl.play(); return false;"><img
                                            src="{{asset('assets/images/icons/play.svg')}}" class="svg_img pro_svg"
                                            alt="play image" /></a>
                                    <a href="#" class="btn btn-default ec-360-btn"
                                        onclick="crl.stop(); return false;"><img
                                            src="{{asset('assets/images/icons/stop.svg')}}" class="svg_img pro_svg"
                                            alt="stop image" /></a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                ...
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('assets/images/product-image/3_2.jpg')}}"
                                        alt="">
                                </div>
                                <div class="qty-slide">
            ...
            <div class="ec-nav-panel">
                ...
                <div class="ec-nav-panel-icons">
                    <a href="wishlist.html" class="ec-header-btn"><img
                            src="{{asset('assets/images/icons/wishlist.svg')}}" class="svg_img header_  svg"
