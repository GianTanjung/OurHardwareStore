...
@section('title', 'Tambah Data Sub Kategori')

@section('cssinsertsubkategori')
...
@section('konteninsertsubkategori')
...
<div class="row mb-4 layout-spacing">
    ...
    <form enctype="multipart/form-data" class="row g-3" method="POST" action="{{ route('subkategori.store') }}">
        @csrf
                    ...
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" value="{{ old('nama') }}"
                                ...
                                placeholder="Masukkan Nama Sub Kategori" autofocus>
                            @error('nama')
