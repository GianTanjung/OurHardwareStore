...
<div class="row mb-4 layout-spacing">
    ...
    <form enctype="multipart/form-data" class="row g-3" method="POST" action="{{ route('supplier.update', $suppliers[0]->id) }}">
        @csrf
        @method("PUT")
            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                ...
                <div class="row mb-4">
                    <div class="col">
                        <label>Nama</label>
                        <div class="col-sm-12">
                            <input type="text" value="{{ $suppliers[0]->nama }}"
                ...
                <div class="row mb-4">
                    <div class="col">
                        <label>No. HP</label>
                        <div class="col-sm-12">
                            <input type="text" value="{{ $suppliers[0]->no_hp }}"
                    ...
                    <div class="col">
                        <label>Email</label>
                        <div class="col-sm-12">
                            <input type="text" value="{{ $suppliers[0]->email }}"
                ...
                <div class="row mb-4">
                    <div class="col">
                        <label>Alamat</label>
                        <div class="col-sm-12">
                            <input type="text" value="{{ $suppliers[0]->alamat }}"
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <select class="form-select @error('provinsi') is-invalid @enderror" name="provinsi" id="provinsi"
                            ...
                            <option value="{{ $provinsi->name }}" {{ $suppliers[0]->provinsi==$provinsi->name ?
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" value="{{ $suppliers[0]->kecamatan }}"
                    ...
                    <div class="col">
                        ...
                        <div class="col-sm-12">
                            <input type="text" value="{{ $suppliers[0]->kode_pos }}"
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" value="{{ $suppliers[0]->keterangan }}" rows="5"
                            placeholder="Masukkan Keterangan" name="deskripsi"></textarea>
                    </div>
