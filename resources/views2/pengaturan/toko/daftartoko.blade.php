        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <table id="style-3" class="table style-3 dt-table-hover">
                    ...
                    <tbody>
                        @foreach ($tokos as $datatoko)
                        <tr>
                            <td><a href="{{ route('toko.show', $datatoko->id) }}">{{ $datatoko->id }}</a></td>
                            <td><a href="{{ route('toko.show', $datatoko->id) }}">{{ $datatoko->nama }}</a></td>
                            <td>{{ $datatoko->no_hp }}</a></td>
                            <td>{{ $datatoko->alamat }}</a></td>

                            <td class="text-center">

                                <form method="POST" action="{{ route('toko.destroy', $datatoko->id) }}">
                                    @csrf
                                    @method("DELETE")

                                    <a class="btn btn-light-primary btn-icon bs-tooltip"
                                        href="{{ route('toko.edit', $datatoko->id) }}" data-bs-toggle="tooltip"
                                    ...
                                    <a class="btn btn-light-danger btn-icon bs-tooltip"
                                        href="{{ route('toko.destroy', $datatoko->id) }}" data-bs-toggle="tooltip"
