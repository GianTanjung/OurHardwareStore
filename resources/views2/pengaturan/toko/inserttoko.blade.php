...
<div class="row mb-4 layout-spacing">
    ...
    <form enctype="multipart/form-data" class="row g-3" method="POST" action="{{ route('toko.store') }}">
        @csrf
            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" value="{{ old('keterangan') }}" rows="5" placeholder="Masukkan Keterangan"
